        ...
        <form id="otr-booking-form" method="post" class="space-y-6">
            ...
            <div class="pt-2">
                <button 
                    ...
                    class="w-full py-4 px-8 rounded-full font-serif tracking-[0.25em] text-sm md:text-base uppercase transition-all duration-300 bg-[#1e1710] hover:bg-[#caa875] text-[#caa875] hover:text-[#080604] border border-[#caa875]/60 hover:border-[#caa875] shadow-[0_4px_25px_rgba(0,0,0,0.6)] hover:shadow-[0_4px_30px_rgba(202,168,117,0.4)] flex items-center justify-center gap-3 cursor-pointer group"
                >
                    <span class="btn-text font-medium group-hover:font-semibold transition-all">ĐẶT BÀN</span>
...
<div id="otr-success-modal" class="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/80 backdrop-blur-md opacity-0 pointer-events-none transition-opacity duration-300">
    <div class="relative w-full max-w-lg bg-[#140e08] border border-[#caa875]/80 rounded-2xl p-7 sm:p-9 text-center shadow-[0_25px_60px_rgba(0,0,0,0.9)] transform scale-95 transition-transform duration-300">
        ...
        <!-- Icon Monogram OTR & Gold Checkmark -->
        ...
        <button 
            type="button" 
            id="modal-close-btn" 
            class="w-full py-3.5 px-6 rounded-full font-serif tracking-[0.2em] text-xs sm:text-sm uppercase bg-[#caa875] text-[#080604] font-bold hover:bg-[#dfbe8c] transition-colors cursor-pointer shadow-lg"
        >
            ĐÓNG CỬA SỔ
        </button>
